...
const { equityService: equity_service } = await import("../../src/services/equity.service.js");
...
describe("equity_service", () => {
  ...
  test(
    "positive_case: converts_numeric_filters_applies_metric_unit_regex_joins_meta_maps_timeline_and_converts_decimal",
    async () => {
      const filters = {
        equityid: "7",
        applicationid: "2",
  ...
  test(
    "query_building_case: when_metric_unit_filters_absent_do_not_include_them_in_key_query",
    async () => {
