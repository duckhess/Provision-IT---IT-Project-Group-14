...
const CovenantsLarge : React.FC<CovenantsLargeProps> = ({category, passList, failList, spotPercentageRate, threeYearAverageSuccess}) => {

    return (
    <div className='flex flex-col items-start w-[100%] h-[800px] bg-gray-100 rounded-lg shadow p-4'>
        
        {/*Header : show the name of the metric, category and relevant data*/}
        ...
        <p>
            ...
            <span className={`ml-1.5 font-semi-bold ${getScoreColour(threeYearAverageSuccess)}`}>
        ...
        <div className="grid grid-cols-2 w-full h-[65%] mt-4 gap-4">
            <div className = "bg-green-50 p-2 rounded-md h-full flex flex-col overflow-y-scroll scrollbar-hide">
                {/**Pass section with number of metric that pass and metric name that passes*/}
            ...
            {/**Fail section with number of metric that fail and metric name that fails*/}
