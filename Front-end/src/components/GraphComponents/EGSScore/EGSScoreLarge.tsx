        ...
        <div className='grid grid-rows-4 gap-4 w-full h-full'>
            ...
            <div className=' bg-white rounded-lg p-4 shadow-md flex items-center justify-between'>
                ...
                <div className='flex items-center gap-2'>
                    <span className = {`text-xl font-bold ${getScoreColour(environment)}`} data-testid="envScoreLarge">{environment}</span>
            ...
            <div className=' bg-white rounded-lg p-4 shadow-md flex items-center justify-between'>
                ...
                <div className='flex items-center gap-2'>
                    <span className = {`text-xl font-bold ${getScoreColour(social)}`} data-testid="socialScoreLarge">{social}</span>
            ...
            <div className=' bg-white rounded-lg p-4 shadow-md flex items-center justify-between'>
                ...
                <div className='flex items-center gap-2'>
                    <span className = {`text-xl font-bold ${getScoreColour(governance)}`} data-testid="govScoreLarge">{governance}</span>
