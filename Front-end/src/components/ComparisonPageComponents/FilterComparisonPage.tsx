...
//   {
//     name: "ABS Benchmarking (ABS Benchmarking)",
...
//     // name: `${items[0].MetricName ?? items[0].AccountDescription ?? items[0].name ?? endpoint} (${endpoint as Metric})`,
...
//   console.log("Keys = " + finalSelectedKeys);
//   return (
//     <div className="flex">
